...
INSERT INTO `ea_node` (`id`, `pid`, `name`, `title`, `level`, `status`, `created_at`, `updated_at`) VALUES(1, 0, 'Admin', '后台管理', 1, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),(2, 1, 'Index', '首页', 2, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),(3, 2, 'index', '查看系统信息', 3, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),(4, 2, 'editPassword', '修改密码页面', 3, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),(5, 2, 'updatePassword', '更新密码', 3, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),(6, 2, 'siteEdit', '编辑站点信息', 3, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),(7, 2, 'siteUpdate', '更新站点信息', 3, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),(8, 1, 'Admins', '管理员权限', 2, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),(9, 8, 'index', '查看管理员列表', 3, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),(10, 8, 'add', '添加管理员', 3, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),(11, 8, 'create', '创建管理员', 3, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),(12, 8, 'edit', '编辑管理员信息', 3, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),(13, 8, 'update', '更新管理员信息', 3, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),(14, 8, 'edit', '编辑管理员信息', 3, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),(15, 1, 'Roles', '角色管理', 2, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),(16, 15, 'index', '查看角色列表', 3, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),(17, 15, 'add', '添加角色', 3, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),(18, 15, 'create', '创建角色', 3, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),(19, 15, 'edit', '编辑角色信息', 3, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),(20, 15, 'update', '更新角色信息', 3, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),(21, 15, 'assignAccess', '编辑角色权限', 3, 1, 0, 0),(22, 15, 'doAssignAccess', '更新角色权限', 3, 1, 0, 0),(23, 1, 'Nodes', '节点管理', 2, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),(24, 23, 'index', '查看节点信息', 3, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),(25, 23, 'toggleStatus', '修改节点状态', 3, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),(26, 1, 'Models', '模型管理', 2, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),(27, 26, 'index', '查看模型列表', 3, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),(28, 26, 'show', '查看模型信息', 3, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),(29, 26, 'add', '添加模型', 3, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),(30, 26, 'create', '创建模型', 3, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),(31, 26, 'edit', '编辑模型信息', 3, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),(32, 26, 'update', '更新模型信息', 3, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),(33, 26, 'delete', '删除模型', 3, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),(34, 26, 'checkModelName', '检查模型名称', 3, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),(35, 26, 'checkTblName', '检查数据表名称', 3, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),(36, 26, 'checkMenuName', '检查菜单名称', 3, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),(37, 1, 'Fields', '字段管理', 2, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),(38, 37, 'index', '查看字段信息列表', 3, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),(39, 37, 'add', '添加字段', 3, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),(40, 37, 'create', '创建字段', 3, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),(41, 37, 'edit', '编辑字段', 3, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),(42, 37, 'update', '更新字段', 3, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),(43, 37, 'delete', '删除字段', 3, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),(44, 37, 'checkFieldName', '检查字段名称', 3, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),(45, 37, 'checkFieldLabel', '检查字段标签', 3, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),(46, 1, 'Data', '数据管理', 2, 1, 1, UNIX_TIMESTAMP()),(47, 46, 'backup', '查看数据备份列表', 3, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),(48, 46, 'doBackup', '处理数据备份', 3, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),(49, 46, 'restore', '查看SQL文件列表', 3, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),(50, 46, 'doRestore', '恢复SQL文件', 3, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),(51, 46, 'deleteSqlFiles', '删除SQL文件', 3, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),(52, 46, 'zipSqlFiles', '打包SQL文件为ZIP', 3, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),(53, 46, 'zipList', '查看ZIP文件列表', 3, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),(54, 46, 'unzipFiles', '解压ZIP文件', 3, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),(55, 46, 'deleteZipFiles', '删除ZIP文件', 3, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),(56, 46, 'downloadFile', '下载SQL、ZIP文件', 3, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),(57, 46, 'optimize', '查看可优化数据表列表', 3, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP()),(58, 46, 'doOptimize', '优化数据表', 3, 1, UNIX_TIMESTAMP(), UNIX_TIMESTAMP());
